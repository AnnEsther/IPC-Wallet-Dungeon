...
class loadingScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('loadAnim', 'assets/load.png',  { frameWidth: 78, frameHeight: 78, endFrame:3 });//450, 469, 76);
        ...
        for(var x in this.loadAssets[this.nextScene])
        {
            //console.log(x);
            var asset = this.loadAssets[this.nextScene][x];
            switch(asset.type)
            {
                case 'image':
